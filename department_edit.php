...
if (!$edit_id) {
    header("Location: admin_departments.php?error=" . urlencode("ID tidak sah."));
    exit;
}
...
if ($result->num_rows == 0) {
    header("Location: admin_departments.php?error=" . urlencode("Jabatan tidak ditemui."));
    exit;
}
