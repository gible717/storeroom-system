<?php
// FILE: admin_reports.php (Option A: Dashboard + Reports)
$pageTitle = "Laporan Sistem";
require 'admin_header.php';

// --- Filter Logic for Quick Tabs + Custom Range ---
$filter_preset = $_GET['preset'] ?? 'month'; // week, month, year, custom
...
FROM permohonan
WHERE DATE(tarikh_mohon) BETWEEN ? AND ?";
...
$total_processed = $cards['jumlah_lulus'] + $cards['jumlah_tolak'];
$approval_rate = $total_processed > 0 ? round(($cards['jumlah_lulus'] / $total_processed) * 100, 1) : 0;
...
.stat-card-icon.bg-primary-light {background-color: #e0e7ff; color: #4f46e5;}
.stat-card-icon.bg-success-light {background-color: #d1fae5; color: #10b981;}
.stat-card-icon.bg-danger-light {background-color: #fee2e2; color: #ef4444;}
.stat-card-icon.bg-warning-light {background-color: #fef3c7; color: #f59e0b;}
.stat-card-info {
    flex-grow: 1;
    text-align: left;
}
...
<h3 class="mb-4 fw-bold">
    <i class="bi bi-graph-up-arrow me-2"></i>Dashboard & Laporan Sistem
</h3>
...
<div class="row g-4 mb-5">
        ...
        <div class="card shadow-sm border-0" style="border-radius: 1rem;">
            <div class="card-body p-4">
                <h6 class="card-title fw-bold mb-3">
                    <i class="bi bi-pie-chart me-2"></i>Pecahan Status Permohonan
                </h6>
    ...
    <div class="col-md-6">
        <div class="card shadow-sm border-0" style="border-radius: 1rem;">
            <div class="card-body p-4">
                <h6 class="card-title fw-bold mb-3">
                    <i class="bi bi-bar-chart me-2"></i>Top 5 Item Paling Diminta
                </h6>
                <div style="height: 300px;">
...
<h5 class="fw-bold mb-3">
    <i class="bi bi-file-earmark-text me-2"></i>Jana Laporan
</h5>
<div class="row g-4">
    <div class="col-md-6">
        <div class="report-action-card">
            ...
            <a href="kewps3_report.php" class="btn btn-success">
                <i class="bi bi-printer me-2"></i>Jana KEW.PS-3
            </a>
        </div>
    </div>
    <div class="col-md-6">
        <div class="report-action-card">
            ...
            <a href="report_requests.php" class="btn btn-primary">
                <i class="bi bi-bar-chart-line me-2"></i>Lihat Analisis
            </a>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customDateModalLabel">
                    <i class="bi bi-calendar-range me-2"></i>Pilih Tempoh Tersuai
                </h5>
